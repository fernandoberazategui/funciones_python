...
print ("La cantidad de numeros negativos de la lista son:",cantidad_numeros_negativos)
print ("La cantidad de numeros positivos de la lista son:",cantidad_numeros_positivos)
print("terminamos!")
